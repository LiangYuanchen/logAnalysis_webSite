...
var res_log_Eqp = function(options)
{
	var self = this;
	try{
		self.data = options;
...
res_log_Eqp.prototype.data = {};

res_log_Eqp.prototype.save = function(callback){
	var self =this;
	var conn = new connBase();
	conn.saveMysql(self.data,"Res_log_Eqp",callback);
}


exports = module.exports = res_log_Eqp;