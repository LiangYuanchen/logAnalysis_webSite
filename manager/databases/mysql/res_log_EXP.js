...
var res_log_Exp = function(options)
{
	var self = this;
	try{
		self.data = options;
...
res_log_Exp.prototype.data = {};

res_log_Exp.prototype.save = function(callback){
	var self =this;
	var conn = new connBase();
	conn.saveMysql(self.data,"Res_log_EXP",callback);
}


exports = module.exports = res_log_Exp;