...
var login = function(project_id,server_id,open_udid,ip,user_id,user_name,created_at,app_id,os_version,device_name,device_id,device_id_type,locale)
{
	var self = this;
...
login.prototype.save = function(cb){
	var conn = new connBase();
	conn.saveObj(this.data,"user_login_logs",cb);
}
