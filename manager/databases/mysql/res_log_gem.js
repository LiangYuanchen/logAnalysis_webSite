...
var res_log_gem = function(options)
{
	var self = this;
	try{
		self.data = options;
...
res_log_gem.prototype.data = {};

res_log_gem.prototype.save = function(callback){
	var self =this;
	var conn = new connBase();
	conn.saveMysql(self.data,"Res_log_Gem",callback);
}


exports = module.exports = res_log_gem;