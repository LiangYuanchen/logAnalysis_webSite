...
var res_log_VIP = function(options)
{
	var self = this;
	try{
		self.data = options;
...
res_log_VIP.prototype.data = {};

res_log_VIP.prototype.save = function(callback){
	var self =this;
	var conn = new connBase();
	conn.saveMysql(self.data,"Res_log_VIP",callback);
}


exports = module.exports = res_log_VIP;