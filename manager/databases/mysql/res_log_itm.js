...
var res_log_itm = function(options)
{
	var self = this;
	try{
		self.data = options;
...
res_log_itm.prototype.data = {};

res_log_itm.prototype.save = function(callback){
	var self =this;
	var conn = new connBase();
	conn.saveMysql(self.data,"Res_log_itm",callback);
}


exports = module.exports = res_log_itm;